...
import { uploadService, geodataService } from '../services/api';
...
export default function DataExplorerPage() {
  ...
  // eliminación
  const [confirmId,      setConfirmId]      = useState(null); // id en modo confirm
  const [deletingId,     setDeletingId]     = useState(null); // id siendo eliminado
      ...
      <div className="dex-scroll">
        <main className="dex-main">
          ...
          <div className="dex-hero">
            ...
            <div>
              <h1 className="dex-title">Datos Cargados</h1>
              <p className="dex-subtitle">
                Explora, previsualiza y gestiona los archivos subidos por esta secretaría.
              </p>
            </div>
          </div>
